...
export default function MetricCard({ label, value, unit, trend }: MetricProps) {
  return (
    <div className="bg-zinc-900/50 p-4 mb:p-6 rounded-2xl backdrop-blur-sm transition-all">
      <h2 className="text-xs font-medium text-zinc-300 uppercase tracking-wider mb-2">
        {label}
      </h2>
